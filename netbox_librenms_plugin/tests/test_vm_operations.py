...
class TestBulkImportVms:
    ...
    def test_job_status_value_attribute_used_when_present(self):
        ...
        mock_job.job.status = mock_status
    ...
    def test_job_log_info_when_not_cancelled_at_checkpoint(self):
        ...
        # Status is "running" at first checkpoint (idx=1), "failed" at second (idx=5)
        ...
        # 10 VMs: checkpoint at idx=1 (running → log.info) and idx=5 (failed → break)
