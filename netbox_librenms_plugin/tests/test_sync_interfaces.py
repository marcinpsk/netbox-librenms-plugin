...
class TestUpdateInterfaceAttributes:
    ...
    def test_sets_speed_via_convert(self):
        view = _make_view()
    ...
    def test_does_not_set_type_for_vm_interface(self):
    ...
    def test_sets_description_only_when_alias_differs_from_name(self):
        from dcim.models import Interface
    ...
    def test_sets_description_when_alias_differs(self):
        from dcim.models import Interface
    ...
    def test_sets_librenms_id_when_port_id_present(self):
        ...
        mock_set.assert_called_once_with(iface, 77, "default")

    def test_does_not_set_librenms_id_when_port_id_none(self):
        from dcim.models import Interface
    ...
    def test_sets_enabled_true_when_admin_status_none(self):
        from dcim.models import Interface
    ...
    def test_sets_enabled_based_on_admin_status_string(self):
        from dcim.models import Interface
    ...
    def test_calls_save_at_end(self):
        from dcim.models import Interface
    ...
    def test_excludes_mac_address_when_in_excluded(self):
        from dcim.models import Interface
...
class TestHandleMacAddress:
    ...
    def test_no_error_when_primary_mac_attribute_absent(self):
